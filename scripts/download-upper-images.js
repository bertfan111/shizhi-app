...
async function main() {
  ...
  const upperChars = ds.characters.filter(c => c.volume === 'upper');
  
  console.log(`🚀 开始在后台为 ${upperChars.length} 个上册文字生成插画...`);
  
  let downloadedCount = 0;
  for (const charData of upperChars) {
